...
const APP_VERSION = "2026-05-14 prompt-variety";
...
if __name__ == "__main__":
  ...
  "typescript": {
    ...
    composePrompt(profile, type, standard, scenario) {
      ...
      return [
        opener,
        "Write outputs/fix.patch, outputs/tsc_report.json, outputs/type_test_results.json, outputs/public_api_report.json, and outputs/run_manifest.json. The four positive fixtures must compile clean under tsconfig.strict.json. invalid_non_thenable.ts must produce exactly one TS2345 under tsconfig.negative.json.",
        "Keep contracts/public_types.md unchanged. The reports must be deterministic and must explain pass/fail status for each fixture."
      ].join("\n\n");
    },
    sources: [
