...
function validateZipReadiness() {
  ...
  if (!f.resources || (!f.resources.includes("data/") && !(isGitWorkflow && hasGitResources)))
    issues.push("Resources must reference concrete input files, either inside data/ or as Git workflow fixtures such as .bundle, reflog_export.txt, and commit_graph_spec.json.");
